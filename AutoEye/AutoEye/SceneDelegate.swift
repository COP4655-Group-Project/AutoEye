...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private enum Constants {
        ...
        static let FAQNavigationControllerIdentifier = "FAQNavigationController"
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        // TODO: Check for cached user for persisted log in.
        if User.current != nil {
            login()
        }
    }
    ...
    private func login() {
        ...
        self.window?.rootViewController = storyboard.instantiateViewController(withIdentifier: Constants.FAQNavigationControllerIdentifier)
    }

    private func logOut() {
        // TODO: Log out Parse user.
